...
function viewItems(){
    var path = 'https://localhost/latihanpw/ajax_lt/assets/scripts/ajax/';
    $('#TableCustomer').html('');
    $.ajax({
        type: "POST",
        ...
        success: function(response){
            ...
            $('.linkk').bind('click', function(e){
                e.preventDefault();
                var idcust = $(this).attr('href');
                $('#txtindex').val(idcust);
...
$(document).ready(function(){
    viewItems();
    var path1 = 'https://localhost/latihanpw/ajax_lt/assets/scripts/ajax';
            ...
            success: function(response){
              ...
              $(jsonData).each(function(i,val){
                $.each(val,function(k,v){
                    switch(k){
                      case 'id'   : $('#txtindex').val(v);$('#h1-1').val('Edit Customer');$('#txtcustid').val(v);break;
                      case 'nm'   : $('#txtnama').val(v);break;
    ...
    $('#cari_cust').click(function(){
      var keyword = $('#keyword').val();
      $.ajax({
        type	: "POST",
        url		: path1+"/searchcust.php",
